...
describe('getTwitchGame', () => {
  ...
  it('should works', done => {
    getTwitchGame('21779').then(fetchedGame => {
      const game = {
        id: '21779',
  ...
  it('should read game from local storage', done => {
    getTwitchGame('21779').then(fetchedGame => {
      const game = {
        id: '21779',
        name: 'League of Legends',
  ...
  it('should throw an error if game does not exist', done => {
    getTwitchGame('12345678').catch((err: Error) => {
